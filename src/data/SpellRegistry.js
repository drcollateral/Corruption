...
// Legacy spell ID aliases (map old ids to new canonical ones)
export const SPELL_ID_ALIASES = Object.freeze({
  burn_dot: 'burn'
});
        ...
        8:  Object.freeze([
          {
            id: "inferno",
            name: "Inferno",
            desc: "Channel a surge of fire: your next fire spell is enhanced; then it radiates, potentially harming nearby units.",
            tags: ["fire","boost","self"],
            roll: "POW",
            actionType: "bonus", // treated as Bonus action in combat
            effects: [
              { type: "selfEffect", apply: { kind: "inferno_next", remaining: 1 } }
            ],
          },
        ]),
        10: Object.freeze([
...
export const ATTR_PASSIVES = Object.freeze({
  ELEMENTALIST: Object.freeze({
    Flame: Object.freeze({
      ...
      POW: Object.freeze({
        16: Object.freeze([
          { id: "conflagrate", name: "Inferno - Conflagration", desc: "Inferno pulses twice whenever it would pulse." }
        ]),
      }),
      DEF: Object.freeze({
        14: Object.freeze([
